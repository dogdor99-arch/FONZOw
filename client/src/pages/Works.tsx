...
export default function Works() {
  ...
  return <>
    <div className="border-b border-border/70 bg-cream/40 px-4 py-4 sm:px-6 lg:px-10"><div className="mx-auto max-w-[1400px]"><p className="text-[9px] tracking-[0.14em] text-muted-foreground uppercase">{t("หน้าแรก", "Home")} <span className="mx-1.5 text-brand">›</span> Works</p><p className="mt-2 text-[10px] tracking-[0.16em] text-brand uppercase">{t("ผลงานของแบรนด์", "Brand works")}</p><h1 className="mt-1 font-display text-3xl leading-none sm:text-4xl">Works</h1></div></div>
