...
export default function Works() {
  ...
  return <>
    <div className="border-b border-border/70 bg-cream/40 px-4 py-4 sm:px-6 lg:px-10"><div className="mx-auto max-w-[1400px] lg:pl-8"><p className="text-[9px] tracking-[0.14em] text-muted-foreground uppercase">{t("หน้าแรก", "Home")} <span className="mx-1.5 text-brand">›</span> Works</p><h1 className="mt-2 font-display text-3xl leading-none sm:text-4xl">Works</h1></div></div>
