    ...
    <>
      <section className="surface-deep relative overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-[1400px] items-center gap-10 px-4 pb-16 pt-12 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:gap-10 lg:px-10 lg:pb-20 lg:pt-16">
          ...
          <Reveal delay={150}><div className="flex items-center justify-center lg:justify-start"><img src={BRAND.logo} alt="Fonzo Guitar" className="w-full max-w-[10rem] object-contain opacity-100 drop-shadow-[0_16px_38px_rgba(0,0,0,0.45)] sm:max-w-[13rem] lg:max-w-[15rem]" /></div></Reveal>
        </div>
      </section>
